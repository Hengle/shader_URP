Shader "URP/GhostWarp" //Shader路径名
{
    Properties //材质面板参数
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            VertexOutput vert(VertexInput v)
            {
                ...
                o.uv0 = v.uv0;
                o.uv1 = TRANSFORM_TEX(v.uv0, _WarpTex); // UV1支持TilingOffset
            ...
            {
                half3 var_WarpTex = SAMPLE_TEXTURE2D(_WarpTex, sampler_WarpTex, i.uv1); //噪声图
                half2 uvBias = (var_WarpTex.rg - 0.5) * _WarpInt; //计算UV偏移值
                half2 uv0 = i.uv0 + uvBias; //应用UV偏移值

                half4 var_MainTex = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, uv0); //偏移后UV采样MainTex
