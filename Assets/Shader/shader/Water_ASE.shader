...
Shader "Water_ASE"
{
	Properties
	{
		...
		_ShallowWaterColor("Shallow Water Color", Color) = (0,1,0.8235295,1)
		[ASEEnd]_DeepWaterColor("Deep Water Color", Color) = (0,0.05882353,1,1)
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float clampDepth8 = Linear01Depth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float3 temp_cast_0 = (( ase_screenPosNorm.w + _Depth )).xxx;
				float3 temp_cast_1 = (0.0).xxx;
				float3 temp_cast_2 = (1.0).xxx;
				float3 clampResult30 = clamp( ( ( ( clampDepth8 * _WorldSpaceCameraPos ) - temp_cast_0 ) * _Strength ) , temp_cast_1 , temp_cast_2 );
				float4 lerpResult33 = lerp( _ShallowWaterColor , _DeepWaterColor , float4( clampResult30 , 0.0 ));
				
				float3 Albedo = lerpResult33.rgb;
...
/*ASEBEGIN
Version=18900
425;828;1872;927;704.4872;-89.07608;1.3;True;True
Node;AmplifyShaderEditor.ScreenPosInputsNode;14;-860.7002,433.6663;Float;False;0;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.BreakToComponentsNode;24;-621.7002,447.6663;Inherit;False;FLOAT4;1;0;FLOAT4;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.RangedFloatNode;26;-609.7002,701.6663;Inherit;False;Property;_Depth;Depth;0;0;Create;True;0;0;0;False;0;False;1;-0.56;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ScreenDepthNode;8;-843.8375,20.80659;Inherit;False;1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldSpaceCameraPos;12;-880.7383,160.9066;Inherit;True;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleAddOpNode;25;-466.7002,592.6663;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-550.3,84.7663;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;27;-302.7002,373.6663;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;29;-268.7002,701.6663;Inherit;False;Property;_Strength;Strength;1;0;Create;True;0;0;0;False;0;False;0;0.65;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;31;-56.7002,666.6663;Inherit;False;Constant;_Float0;Float 0;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;32;-57.7002,761.6663;Inherit;False;Constant;_Float1;Float 1;1;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;28;-88.7002,564.6663;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;35;115.2998,360.6663;Inherit;False;Property;_DeepWaterColor;Deep Water Color;3;0;Create;True;0;0;0;False;0;False;0,0.05882353,1,1;0,0.05882346,1,0.5176471;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;34;109.2998,174.6663;Inherit;False;Property;_ShallowWaterColor;Shallow Water Color;2;0;Create;True;0;0;0;False;0;False;0,1,0.8235295,1;0,1,0.8235295,0.2901961;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ClampOpNode;30;121.2998,603.6663;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;1,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;33;404.2998,425.6663;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=09E3E581DC07C2C35ED6B7822C62A54C794C31FA