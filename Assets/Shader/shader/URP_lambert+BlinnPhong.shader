Shader "URP/Lambert+BlinnPhong" //Shader路径名
{
    Properties //材质面板参数
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(VertexOutput i) : COLOR //像素shader
            {
                ...
                float3 finalRGB = (_MainCol * lambert * SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, i.uv0) +
                    _SpecularCol * blinnPhong) * mylight.color;
                //返回结果
